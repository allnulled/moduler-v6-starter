module.exports = $moduler.export("#Std", [], async function ([]) {
            ...
            return _possible_constructor_return(
              ...
              _is_native_reflect_construct()
                ? Reflect.construct(
                    e,
                    t || [],
                    _get_prototype_of(u).constructor,
                  )
                : e.apply(u, t),
            );
          }
          ...
          (function (u, e) {
            if (
              (typeof exports === "undefined"
                ? "undefined"
                : _type_of(exports)) == "object" &&
              (typeof module === "undefined" ? "undefined" : _type_of(module)) <
                "u"
            ) {
              module.exports = e();
            ...
            (typeof globalThis === "undefined"
              ...
              ? globalThis
              : (typeof self === "undefined" ? "undefined" : _type_of(self)) <
                  "u"
                ? self
                : this,
            function () {
                      ...
                      [
                        {
                          ...
                          value: function u(u) {
                            return u.source &&
                              typeof u.source.offset == "function"
                    ...
                    function r(u) {
                      return function (t) {
                        ...
                        t[u].forEach(function (u) {
                          return e.apply(
                            void 0,
                            [u].concat(_to_consumable_array(r)),
                          );
                        });
                      };
                    }
                      ...
                      grammar: function u(u) {
                        ...
                        try {
                          for (
                            ...
                            e.apply(
                              void 0,
                              [l].concat(_to_consumable_array(n)),
                            );
                          }
                        } catch (u) {
                          a = true;
                        ...
                        if (u.topLevelInitializer)
                          if (Array.isArray(u.topLevelInitializer))
                            try {
                              for (
                                var f =
                                    u.topLevelInitializer[Symbol.iterator](),
                                  E;
                                !(A = (E = f.next()).done);
                                A = true
                              ) {
                                ...
                                e.apply(
                                  void 0,
                                  [C].concat(_to_consumable_array(n)),
                                );
                              }
                            } catch (u) {
                              F = true;
                          ...
                          if (Array.isArray(u.initializer))
                            try {
                              for (
                                ...
                                e.apply(
                                  void 0,
                                  [g].concat(_to_consumable_array(n)),
                                );
                              }
                            } catch (u) {
                              h = true;
                  ...
                  function g(u, e, t) {
                    ...
                    return h(
                      ...
                      B(
                        ...
                        h(
                          [r.POP],
                          [e ? r.POP : r.POP_CURR_POS],
                          [r.PUSH_UNDEFINED],
                        ),
                        h(
                          [r.POP],
                          [e ? r.POP_CURR_POS : r.POP],
                          [r.PUSH_FAILED],
                        ),
                      ),
                    );
              ...
              var mt = U(function (u) {
                ...
                var f = function u(u, e) {
                  ...
                  if (n === "scheme-relative")
                    return s(e, s(u, B)).slice(h.length);
                  if (t === "path-absolute") return g(e);
                  if (n === "path-absolute")
                    return s(e, s(u, B)).slice(B.length);
                  var r = A(e + u),
                    o = s(e, s(u, r));
                  return p(r, o);
                };
                              ...
                              (this._sourceRoot != null &&
                                ...
                                e != null
                                  ? (this._sourcesContents ||
                                      (this._sourcesContents =
                                        Object.create(null)),
                                    (this._sourcesContents[t.toSetString(n)] =
                                      e))
                                  : this._sourcesContents &&
                              ...
                              (this._mappings.unsortedForEach(function (e) {
                                if (e.source === o && e.originalLine != null) {
                                  ...
                                  n.source != null &&
                                    ((e.source = n.source),
                                    r != null &&
                                      (e.source = t.join(r, e.source)),
                                    a != null &&
                                      (e.source = t.relative(a, e.source)),
                              ...
                              return (
                                e.eachMapping(function (u) {
                                  ...
                                  (u.source != null &&
                                    ((e.source = u.source),
                                    n != null &&
                                      (e.source = t.relative(n, e.source)),
                                    (e.original = {
                                      line: u.originalLine,
                        ...
                        [
                          ...
                          },
                          {
                            ...
                            value: function u(u) {
                              var e;
                              for (
                                var t = 0, n = this.children.length;
                                t < n;
                                t++
                              )
                                ((e = this.children[t]),
                          ...
                          },
                          {
                            ...
                            value: function u(u) {
                              for (
                                var e = 0, n = this.children.length;
                                e < n;
                                e++
                              )
                                this.children[e][o] &&
                  ...
                  function tz(u, e, t) {
                    ...
                    return (
                      t &&
                        ...
                        ((o.start = i.offset(o.start)),
                        (o.end = i.offset(o.end))),
                      o
                    );
                  }
                ...
                var r = function u(u, e) {
                      ...
                      var t = function () {
                        switch (e[n]) {
                          ...
                          case a.TEXT:
                            (i.push(
                              E.push(
                                "input.substring(" + E.pop() + ", peg$currPos)",
                              ),
                            ),
                              n++);
                            break;
                  ...
                  function L(t) {
                    ...
                    function r() {
                      ...
                      return (
                        e.trace &&
                          u.push("  DefaultTracer: peg$DefaultTracer,"),
                        e.allowedStartRules &&
                          u.push(
                            "  StartRules: [" +
                              e.allowedStartRules
                    ...
                    var o = {
                      ...
                      es: function r() {
                        ...
                        return (
                          ...
                          o.push("export {"),
                          e.trace &&
                            o.push("  peg$DefaultTracer as DefaultTracer,"),
                          o.push(
              ...
              var kr = U(function (u, e) {
                ...
                var t = function u(u, e, t) {
                  function o(u) {
                    return (
                      u.type === "rule" && u.expression.type === "rule_ref"
                    );
                  }
                    ...
                    repeated: function e(e) {
                      if (
                        ...
                        !(
                          n.alwaysConsumesOnSuccess(u, e.expression) ||
                          (e.delimiter &&
                            n.alwaysConsumesOnSuccess(u, e.delimiter))
                        ))
                      )
                        if (e.max.value === null)
                          t.error(
  ...
  return (function () {
    ...
    Wave_1_Elemental_functions_classes_and_interfaces: {
      ...
      Std.all.Environmenter = Std.classes.Environmenter = class Environmenter {
        /**
         *
      ...
      Std.all.Ansi = Std.objects.Ansi = ((Colors) => {
        /**
         *
         * # Std.objects.Ansi
         *
    ...
    Wave_2_Utility_interfaces: {
      ...
      Std.all.ValidationStepInterface = Std.interfaces.ValidationStepInterface =
      ...
      Std.all.TypesValidatorInterface = Std.interfaces.TypesValidatorInterface =
            ...
            validateData: async function validateData(
              ...
              All_validation: {
                Step_1_Initialize: {
                  state =
                    stateBrute ||
                    Std.classes.ValidationState.new.config({ data, validator });
                  step =
                    stepBrute ||
