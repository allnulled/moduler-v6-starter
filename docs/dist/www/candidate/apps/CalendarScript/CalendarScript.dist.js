(function (mod) {
  ...
  return class CalendarScript {
    static AssertionError = class extends Error { constructor(...args) { super(...args); this.name = "AssertionError"; }} ;    static assert(condition, message) { if(!condition) throw new this.AssertionError(message); }    static Parser = (() => {
let __firstHolder = {};
...
(function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$startRuleFunctions = { json_value: peg$parsejson_value },
        peg$startRuleFunction  = peg$parsejson_value,
...
return __output;
  ...
  static CalendarScript = CalendarScript;  static assert = CalendarScript.assert;  name = null;  constructor(textOrObject) {
  if (typeof textOrObject === "string") this.text = textOrObject;
  else if (typeof textOrObject === "object") this.data = textOrObject;
}  set text(value) {
  this.data = this.constructor.CalendarScript.Parser.parse(value);
}  set data(value) {
...
const exports = module.exports;
const __result = (() => {
class Fecha extends Expression {
...
const exports = module.exports;
const __result = (() => {
class Duracion extends Expression {
