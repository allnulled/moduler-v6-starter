module.exports = async function ({ Tester }) {
  ...
  Write_has_y_delete_file: {
    const input1 =
      "@src/www/dev/test/feature/005.Std.classes.IdbFilesystem puede hacer operaciones básicas/asset1.txt";
    const input2 =
      "@src/www/dev/test/feature/005.Std.classes.IdbFilesystem puede hacer operaciones básicas/impossible/asset2.txt";
  ...
  Write_has_y_delete_directory: {
    const dir1 =
      "@src/www/dev/test/feature/005.Std.classes.IdbFilesystem puede hacer operaciones básicas/somedir";
