globalThis.PEG = (function (undefined) {
  "use strict";
    ...
    var javascript = {
      ...
      regexpClassEscape: function (s) {
        ...
        return s
          ...
          .replace(/\f/g, "\\f") // form feed
          .replace(/\r/g, "\\r") // carriage return
          .replace(/[\x00-\x08\x0E\x0F]/g, function (ch) {
            return "\\x0" + hex(ch);
          })
          .replace(/[\x10-\x1F\x80-\xFF]/g, function (ch) {
            return "\\x" + hex(ch);
      ...
      function generateJavascript(ast, options) {
        ...
        function generateTables() {
          if (options.optimize === "size") {
            return [
              ...
              indent2(
                arrays
                  .map(ast.rules, function (rule) {
                    return (
                      'peg$decode("' +
                      js.stringEscape(
                        arrays
                          .map(rule.bytecode, function (b) {
        ...
        if (options.optimize === "size") {
          startRuleIndices =
            "{ " +
            arrays
              .map(options.allowedStartRules, function (r) {
