...
(
      ...
      function () {
        return class ModulerV6 {
          ...
          static Toolkit = class Toolkit {
             ...
             * @description
             */
            makeTrait = ModulerV6.ClassSkiller.mixTraits;
             ...
             * @description
             */
            makeClass = ModulerV6.ClassSkiller.addInterfaces;
          };
          /**
          ...
          _joinPaths(subpathsInput, origin = false) {
            ...
            Join_paths_overwritting_when_required: for (
              ...
              if (subpath.includes("://")) {
                ...
                out =
                  this._appendPathSeparator(this.basedir) + subpath.substr(2);
              } else if (subpath.startsWith("../")) {
                ...
                out =
                  this._appendPathSeparator(this.rootdir) + subpath.substr(2);
              } else {
  ...
  //*/
      ...
      _initializeLogger(directory) {
        ...
        return (this._logger = this.constructor.Logger.Manager.fromDirectory(
          directory,
          this,
        ));
      }
