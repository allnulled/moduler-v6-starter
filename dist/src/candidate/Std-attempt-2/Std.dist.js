module.exports = $moduler.export("#Std", function () {
  ...
  Interfaces_basicas: {
    Object.assign(Std.all, {
      ConfigurableInterface: (Std.interfaces.ConfigurableInterface = {
        static: {},
        prototype: {
          config(props = {}) {
      ...
      CreableInterface: (Std.interfaces.CreableInterface = {
        static: {
      ...
      ClonableInterface: (Std.interfaces.ClonableInterface = {
        static: {},
        prototype: {
      ...
      RunnableInterface: (Std.interfaces.RunnableInterface = {
        static: {},
        prototype: {
  ...
  Object.assign(Std.all, {
    ClassSkiller2: (Std.classes.ClassSkiller = class ClassSkiller {
      static getDescriptorsOf(target) {
        return Object.getOwnPropertyDescriptors(target);
      }
      static mixInterfaces(interfazes = []) {}
      static addInterfaces(clazz, interfazes = []) {}
    }),
    ClassSkiller: (Std.classes.ClassSkiller = class ClassBuilder {
      ...
      static addInterface(base, interfaceObject) {
        ...
        this.assert(
          ...
          `Parameter «interfaceObject» must be object but «${typeof interfaceObject}» was found instead on «ClassSkiller.addInterface»`,
        );
        this.assert(
    ...
    Asserter: (Std.classes.Asserter = class Asserter {
      ...
      static assertDoesNotThrowSync(callback) {
        ...
        try {
          ...
          throw new this.constructor.AssertionError(
            `Should not have thrown (sync): ${err.name}: ${err.message}`,
            err,
          );
        }
      }
      static async assertDoesNotThrowAsync(callback) {
        ...
        try {
          ...
          throw new this.constructor.AssertionError(
            `Should not have thrown (async): ${err.name}: ${err.message}`,
            err,
          );
        }
      }
        ...
        Std.all.ClassSkiller.addInterfaces(this, [
          ...
          Std.all.RunnableInterface,
          {
            ...
            prototype: {
              ...
              onRunCatch: Std.all.createIsolationCatcher(
                "Isolation ${title} failed",
              ),
              onRunEnd: undefined,
            },
          },
