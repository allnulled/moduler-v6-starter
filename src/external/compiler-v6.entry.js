    ...
    const CompilerV6 = class CompilerV6 {
        ...
        async _compileRecursively(fileParameters = {}, processParameters = {}) {
            ...
            If_file_is_root: if (fileParameters.isRoot) {
                ...
                And_file_is_entry: if (compilationFile.resource.endsWith(".entry.js")) {
        ...
        async _compileAsInjects(compilationFile, compilationProcess, {token: token, tokenIndex: tokenIndex}) {
            ...
            Early_delegation_to_compileAsInjectSource: {
                ...
                return await this._compileAsInjectSource(compilationFile, compilationProcess, {
                    token: token,
                    tokenIndex: tokenIndex
                });
            }
            ...
            Inject_in_compilation_text: {
                if (compilationFile.resource.endsWith(".js")) {
                    ...
                    } else if (targetPath.endsWith(".md")) {} else {
