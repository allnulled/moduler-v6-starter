(Colors => {
  ...
  nodejsStyle: function (config) {
    ...
    return {
      text: (text) => {
        const begin = styles.reduce(this.nodejsStylesReductor.bind(this), "");
      ...
      open: (text = "") => {
        console.log(styles.reduce(this.nodejsStylesReductor.bind(this), "") + text);
      }
    };
  },
  style: Object.assign(function (config = "red,bold,underline") {
