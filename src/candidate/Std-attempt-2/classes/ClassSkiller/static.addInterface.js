static addInterface(base, interfaceObject) {
  ...
  this.assert(typeof interfaceObject === "object", `Parameter «interfaceObject» must be object but «${typeof interfaceObject}» was found instead on «ClassSkiller.addInterface»`);
