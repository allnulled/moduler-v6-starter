(function(factory) {
  ...
  function _call_super(u, e, t) {
    ...
    return _possible_constructor_return(u,
      _is_native_reflect_construct() ?
        Reflect.construct(e, t || [],
          _get_prototype_of(u)
            .constructor) : e.apply(u, t))
  }
  ...
  function _construct(u, e, t) {
    if (_is_native_reflect_construct()) {
      ...
      _construct = function u(u, e, t) {
        var n = [null];
        n.push.apply(n, e);
        var r = Function.bind.apply(u,
          n);
        var o = new r;
        if (t) _set_prototype_of(o, t
          .prototype);
        return o
      }
    }
  ...
  function _create_class(u, e, t) {
    if (e) _defineProperties(u.prototype,
      e);
  ...
  function _get_prototype_of(u) {
    _get_prototype_of = Object
      .setPrototypeOf ? Object
      .getPrototypeOf : function u(u) {
        return u.__proto__ || Object
          .getPrototypeOf(u)
      };
  ...
  function _instanceof(u, e) {
    if (e != null && typeof Symbol !==
      "undefined" && e[Symbol.hasInstance]
    ) {
  ...
  function _is_native_function(u) {
    return Function.toString.call(u)
      .indexOf("[native code]") !== -1
  }

  function _iterable_to_array(u) {
    if (typeof Symbol !== "undefined" &&
      u[Symbol.iterator] != null || u[
      "@@iterator"] != null)
      return Array.from(u)
  }

  function _iterable_to_array_limit(u,
    e) {
    var t = u == null ? null :
      typeof Symbol !== "undefined" && u[
      Symbol.iterator] || u[
      "@@iterator"];
    if (t == null) return;
    var n = [];
  ...
  function _object_spread(u) {
    for (var e = 1; e < arguments
      .length; e++) {
      var t = arguments[e] != null ?
        arguments[e] : {};
      var n = Object.keys(t);
      if (typeof Object
  ...
  function _object_spread_props(u, e) {
    ...
    if (Object
      ...
      Object.defineProperties(u, Object
  ...
  function _possible_constructor_return(u,
    e) {
    if (e && (_type_of(e) === "object" ||
      typeof e === "function")) {
      return e
    }
  ...
  function _set_prototype_of(u, e) {
    _set_prototype_of = Object
      .setPrototypeOf || function u(u,
        e) {
        u.__proto__ = e;
        return u
      };
  ...
  function _type_of(u) {
    "@swc/helpers - typeof";
    return u && typeof Symbol !==
      "undefined" && u.constructor ===
      Symbol ? "symbol" : typeof u
  }
  ...
  function _wrap_native_super(u) {
    var e = typeof Map === "function" ?
      new Map : undefined;
    _wrap_native_super = function u(u) {
      if (u === null || !
        _is_native_function(u))
        return u;
      ...
      function t() {
        return _construct(u, arguments,
          _get_prototype_of(this)
            .constructor)
      }
  ...
  function _is_native_reflect_construct() {
    try {
      var u = !Boolean.prototype.valueOf
        .call(Reflect.construct(Boolean,
          [], function () { }))
    } catch (u) { }
    ...
    "undefined" : _type_of(globalThis)
  ) < "u" ? globalThis : (
    typeof self === "undefined" ?
      "undefined" : _type_of(self)) <
    "u" ? self : this,
    function () {
      var exports = {};
      ...
      var he = U(function (u, e) {
        ...
        var t = function u(u, e) {
          if (!(u && e)) return u ||
            e;
          var t = Array.isArray(u) ?
            u : [u];
          return t.push(e), t
        };
        var n = K();
        var r = {
          findRule: function u(u,
            e) {
            for (var t = 0; t < u
              .rules.length; t++)
              if (u.rules[t]
          ...
          alwaysConsumesOnSuccess: function u(
            u, e) {
            function t() {
              return !0
            }
      ...
      var ir = U(function (u, e) {
        ...
        var t = function u(u, e) {
          ...
          var R = w({
            ...
            semantic_and: function u(
              u, e) {
              return m(u, !1,
                e)
            },
            semantic_not: function u(
              u, e) {
              return m(u, !0,
                e)
            },
      ...
      var ts = U(function (u, e) {
        ...
        var t = function u(u, e) {
          ...
          function ej(u) {
            return ra.has(u[0]) &&
              tL(
                "Binding identifier can't be a reserved word \""
                  .concat(u[0], '"'),
                u[1]), u[0]
          }
          ...
          function eX(u) {
            return ra.has(u[0]) &&
              tL(
                "Label can't be a reserved word \""
                  .concat(u[0], '"'),
                u[1]), u
          }
            ...
            function C(e) {
              ...
              function A(u) {
                switch (u) {
                  ...
                  default:
                    return "input.substr(peg$currPos, "
                      .concat(u,
                        ")")
                }
              }
                ...
                if (e.max
                  ...
                  t.warning(r
                    ...
                    e.max
                      .type ===
                    "constant" ?
                    "An expression may not consume any input and may always match "
                      .concat(
                        e.max
                          .value,
                        " times"
        ...
        var compiler = {
          ...
          compile: function compile(
            ...
            if (options =
              ...
              throw new Error(
                "allowedStartRules must be an array"
              );
            options
              .allowedStartRules
              .length === 0 && (
      ...
      var Jl = ft(),
        ...
        ta = ["break", "case", "catch",
          ...
          "this", "throw", "try",
          "typeof", "var", "void",
          "while", "with", "null", "true",
          "false", "enum", "implements",
        ...
        Ke = {
          ...
          generate: function u(u, e) {
            ...
            var n = "plugins" in e ? e
              .plugins : [],
              r = {
                parser: Ke.parser,
                passes: t(Ke.compiler
                  .passes),
                reservedWords: Ke
                  .RESERVED_WORDS
                  .slice()
            ...
            return Ke.compiler.compile(
              o, r.passes, e)
          }
        };
      module.exports = Ke;
      if (__exports != exports) module
        .exports = exports;
